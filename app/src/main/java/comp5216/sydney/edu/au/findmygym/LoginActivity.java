...
public class LoginActivity extends BaseActivity {
    ...
    ActivityResultLauncher<Intent> googleSignInLauncher = registerForActivityResult(
            ...
            result -> {
                Log.d(TAG, "Google sign in result: " + result.getResultCode());
//                if (result.getResultCode() == RESULT_OK) {
                    Task<GoogleSignInAccount> task =
                        ...
                        try {
                            ...
                            Log.w(TAG, "Google sign in failed because of api exception", e);
...
//        startActivity(intent);
    ...
    public void onGoogleClicked(View view) {
        Log.d(TAG, "onGoogleClicked: clicked!");
        signIn();
    }
